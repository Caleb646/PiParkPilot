...
cv_file.write("left_stereo_projection", projMatrixL)
cv_file.write("right_stereo_projection", projMatrixR)
cv_file.write("focal_length_mm", (focal_y_mm + focal_x_mm) / 2)
